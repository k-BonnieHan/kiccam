...
<jsp:useBean id="biddingMgr" class="order.BiddingMgr" />
...
<table style="width: 90%">
	<tr style="background-color:pink;"><th>주문번호</th><th>상품명</th><th>주문수량</th><th>입찰가격</th><th>주문일자</th><th>주문상태</th></tr>
	<%
	String id = (String)session.getAttribute("idKey"); //주문한 회원 아이디 읽기, db에는 모든 회원의 주문내역이 있어서
	//본인것만 읽을 수 있도록 session으로 잡아서 읽어준다.
	ArrayList<OrderDto> list = biddingMgr.getOrder(id);
	if(list.size() == 0){
	%>
	<tr>
